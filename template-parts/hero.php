<section id="hero" class="hero-section">
        <div class="container hero-container">
            <div class="hero-content">
                ...
                <span class="gradient-text">DrugZero Bangladesh</span>
                </h1>
            ...
            <div class="hero-image">
                <img src="<?php echo get_theme_mod('hero_image_setting', get_theme_file_uri() . '/assets/images/Community support group.webp'); ?>" alt="<?php echo esc_attr( get_bloginfo('name')); ?>">
            </div>
        </div>
    </section>